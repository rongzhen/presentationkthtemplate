...
& \ebloch<n><k> {\expg<k> \ubloch<n><k>} = \left\{ \frac {{\bf p}^2} {2m} + V({\bf r}) \right\} {\expg<k> \ubloch<n><k>} \\
& = \expg<k> \left \{ \frac {{\bf p}^2} {2m} + V({\bf r}) +  \frac {{\bf k}^2 \hbar^2 } {2m}  + \frac { \hbar {\bf k \cdot p}} {m}  \right\} \ubloch<n><k>
\end{split}
\end{equation} 

so 
 \begin{equation} \label{9}
\ebloch<n><k> {\ubloch<n><k>} = \left \{ \frac {{\bf p}^2} {2m} + V({\bf r}) +  \frac {{\bf k}^2 \hbar^2 } {2m}  + \frac { \hbar {\bf k \cdot p}} {m}  \right\} \ubloch<n><k>
\end{equation} 
\end{comment}
